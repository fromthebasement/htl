...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.fromthebasement.service.impl.PasswordTokenManager#generateRecoveryToken(com.fromthebasement.model.User)
     */
    @Override
    ...
    /**
     * @see com.fromthebasement.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.fromthebasement.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.fromthebasement.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
